...
`;function x(r){return r===l?l:y.includes(r)?r:u}function B(r,n=!1){const t=x(r);return t!==l?t:n?"dark":"light"}function g(r=":root",n=N,t={}){const i=Object.entries({...n,...t}).map(([b,v])=>`  ${b}: ${v};`).join(`
`);return`${r} {
${i}
