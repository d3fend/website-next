import{s as v,e as h,d as p,v as D,w as A,k as T,n as u,i as y,b,M as E,f as x,j as w,N as F,l}from"../chunks/scheduler.BuUavueM.js";import{S as k,i as C,c as j,b as q,m as S,t as I,a as _,d as z}from"../chunks/index.B8nkrWGc.js";import{m as O}from"../chunks/marked.esm.D23x4JZT.js";/* empty css                                                    */function L(r){let e,t='<div style="display: flex; just-content: space-between; align-items: center;"><div style="text-align: center; flex-grow: 1;"><h1 class="fancy-font">D3FEND <span class="snakes">☤</span> <span class="CAD"><span style="color:#e62929;">C</span><span class="A" style="color:white;text-border:1px;">A</span><span style="color:blue;">D</span></span></h1> <div style="text-align: center; padding: 0 px"><i>Cyber Attack-Defense Utility for Capturing Engagements and Understandable Scenarios</i></div> <br/></div></div>';return{c(){e=h("div"),e.innerHTML=t,this.h()},l(a){e=p(a,"DIV",{class:!0,"data-svelte-h":!0}),D(e)!=="svelte-60rjil"&&(e.innerHTML=t),this.h()},h(){A(e,"class","title-egg")},m(a,n){T(a,e,n)},p:u,i:u,o:u,d(a){a&&y(e)}}}class P extends k{constructor(e){super(),C(this,e,null,L,v,{})}}function R(r){let e,t,a,n,c,N=O(r[0])+"",f,o,m=`.content {
      min-width: 800px;
      max-width: 100%;
      overflow-x: auto;
    }
    ...
    }`,d;return t=new P({}),{c(){e=h("div"),j(t.$$.fragment),a=b(),n=h("section"),c=new E(!1),f=b(),o=h("style"),o.textContent=m,this.h()},l(s){e=p(s,"DIV",{});var i=x(e);q(t.$$.fragment,i),a=w(i),n=p(i,"SECTION",{class:!0});var g=x(n);c=F(g,!1),g.forEach(y),f=w(i),o=p(i,"STYLE",{"data-svelte-h":!0}),D(o)!=="svelte-1nfohk8"&&(o.textContent=m),i.forEach(y),this.h()},h(){c.a=null,A(n,"class","content")},m(s,i){T(s,e,i),S(t,e,null),l(e,a),l(e,n),c.m(N,n),l(e,f),l(e,o),d=!0},p:u,i(s){d||(I(t.$$.fragment,s),d=!0)},o(s){_(t.$$.fragment,s),d=!1},d(s){s&&y(e),z(t)}}}function U(r){return[`
# D3FEND CAD User Guide
Put the D3FEND ontology into action with the D3FEND **CAD** Tool!

CAD is a versatile tool designed to support many modeling and graphing use cases. A CAD graph functions as an implementation of the D3FEND ontology, also known as "instances" of the ontology's classes. 
...
## 2. CAD UI Elements
<p align="left"><img src="/img/ui_overview.jpg" style="border: 3px solid #555" alt="CAD UI Overview"></p>
...
<p align="left"><img src="/img/canvas_overview.jpg" style="border: 3px solid #555" alt="CAD Canvas Overview"></p>
...
Miscellaneous nodes are entities that can provide additional context about other nodes or capture things that aren't in the D3FEND ontology.
...
Relationships between two node instances can be added by left-clicking on one of the black circles that appear on each side of a node instance after it has been selected (it will be highlighted in blue), and then (while still holding down the mouse button) dragging the dotted line that appears to another node.  Note that relationships are directional, and the direction is determined automatically as going from the starting node (source) to the destination node (target).
...
To delete a relationship, select a relationship between two nodes and hit the backspace button. Note: make sure that the relationship itself is selected, versus its label. Once selected, the edge that constitutes the relationship will be highlighted in black. This may require zooming in on the relationship so that it is easier to select.
...
### 8.1 STIX 2.1 → D3FEND Mappings
|STIX 2.1 Object|D3FEND Ontology Class|
|---------------|---------------------|
...
`]}class H extends k{constructor(e){super(),C(this,e,U,R,v,{})}}export{H as component};
