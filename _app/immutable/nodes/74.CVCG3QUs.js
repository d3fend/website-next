...
`;function At(a){return{c:X,l:X,m:X,p:X,d:X}}function It(a){let e,t=a[25]+"",l;return{c(){e=v("pre"),l=O(t),this.h()},l(n){e=p(n,"PRE",{class:!0});var s=y(e);l=z(s,t),s.forEach(h),this.h()},h(){_(e,"class","svelte-tky2v8")},m(n,s){F(n,e,s),f(e,l)},p(n,s){s&16&&t!==(t=n[25]+"")&&Z(l,t)},d(n){n&&h(e)}}}function Tt(a){let e;return{c(){e=O("...loading")},l(t){e=z(t,"...loading")},m(t,l){F(t,e,l)},p:X,d(t){t&&h(e)}}}function Nt(a){let e,t,l,n,s='<h1 class="svelte-tky2v8"><span class="fancy-font">D3FEND</span> Embeddable CAD</h1> <h6 class="svelte-tky2v8">Use the D3FEND Embeddable CAD to embed an interactive D3FEND CAD in another webpage.</h6>',d,r,o,c,i,u,m,E,b,w,k,g,C,R,H,U,G=a[3].text+"",Q,K,L,j,x,D,V,W,Y,se,B,N,I,T,P,J,te,ee;e=new ut({props:{title:"Embedded D3FEND CAD",og_title:"MITRE Embedded D3FEND CAD",og_type:"website",og_url:"https://d3fend.mitre.org/",og_image:"https://d3fend.mitre.org/img/d3fend-og.png",og_description:"D3FEND CAD Analysis."}}),o=new Et({props:{containerSize:a[5],metaData:a[6]}});function ue($){a[18]($)}let ae={inputClassName:"autocomplete-cursor-select",items:Object.values(a[7]),labelFieldName:"name",readonly:!0,onChange:a[17]};a[3]!==void 0&&(ae.selectedItem=a[3]),b=new ht({props:ae}),be.push(()=>dt(b,"selectedItem",ue));let q={ctx:a,current:null,token:null,hasCatch:!1,pending:Tt,then:It,catch:At,value:25};return Oe(C=a[4],q),N=new yt({props:{metaData:a[6]}}),{c(){he(e.$$.fragment),t=S(),l=v("main"),n=v("section"),n.innerHTML=s,d=S(),r=v("code"),he(o.$$.fragment),c=S(),i=v("code"),u=v("h3"),m=O(`Embed Code

      `),E=v("span"),he(b.$$.fragment),k=S(),g=v("div"),q.block.c(),R=S(),H=v("div"),U=v("div"),Q=O(G),K=S(),L=v("button"),j=O("Download"),D=S(),V=v("button"),W=O("Copy to Clipboard"),se=S(),B=v("div"),he(N.$$.fragment),I=S(),T=v("iframe"),this.h()},l($){me(e.$$.fragment,$),t=A($),l=p($,"MAIN",{style:!0,class:!0});var M=y(l);n=p(M,"SECTION",{id:!0,class:!0,"data-svelte-h":!0}),ce(n)!=="svelte-1mht16m"&&(n.innerHTML=s),d=A(M),r=p(M,"CODE",{id:!0,class:!0});var fe=y(r);me(o.$$.fragment,fe),fe.forEach(h),c=A(M),i=p(M,"CODE",{id:!0,class:!0});var ie=y(i);u=p(ie,"H3",{class:!0});var Ee=y(u);m=z(Ee,`Embed Code

      `),E=p(Ee,"SPAN",{id:!0,class:!0});var Ie=y(E);me(b.$$.fragment,Ie),Ie.forEach(h),Ee.forEach(h),k=A(ie),g=p(ie,"DIV",{id:!0,class:!0});var Te=y(g);q.block.l(Te),Te.forEach(h),R=A(ie),H=p(ie,"DIV",{id:!0,class:!0});var re=y(H);U=p(re,"DIV",{});var Ne=y(U);Q=z(Ne,G),Ne.forEach(h),K=A(re),L=p(re,"BUTTON",{class:!0});var Pe=y(L);j=z(Pe,"Download"),Pe.forEach(h),D=A(re),V=p(re,"BUTTON",{class:!0});var $e=y(V);W=z($e,"Copy to Clipboard"),$e.forEach(h),re.forEach(h),ie.forEach(h),se=A(M),B=p(M,"DIV",{id:!0,class:!0});var Fe=y(B);me(N.$$.fragment,Fe),Fe.forEach(h),I=A(M),T=p(M,"IFRAME",{id:!0,src:!0,title:!0,class:!0}),y(T).forEach(h),M.forEach(h),this.h()},h(){_(n,"id","header"),_(n,"class","svelte-tky2v8"),_(r,"id","embed-settings"),_(r,"class","svelte-tky2v8"),_(E,"id","download-options"),_(E,"class","svelte-tky2v8"),_(u,"class","svelte-tky2v8"),_(g,"id","code-container"),_(g,"class","svelte-tky2v8"),_(L,"class","download-code svelte-tky2v8"),L.disabled=x=a[3].name==="Config Settings",_(V,"class","download-code svelte-tky2v8"),V.disabled=Y=a[3].name==="Config Settings",_(H,"id","download-container"),_(H,"class","svelte-tky2v8"),_(i,"id","embed-code"),_(i,"class","config-container svelte-tky2v8"),_(B,"id","metadata-render"),_(B,"class","svelte-tky2v8"),_(T,"id","cad-iframe"),it(T.src,P="/cad-frame/")||_(T,"src",P),_(T,"title","D3FEND Embedded CAD"),_(T,"class","svelte-tky2v8"),de(l,"--container-size",a[1]+"%"),_(l,"class","svelte-tky2v8")},m($,M){_e(e,$,M),F($,t,M),F($,l,M),f(l,n),f(l,d),f(l,r),_e(o,r,null),f(l,c),f(l,i),f(i,u),f(u,m),f(u,E),_e(b,E,null),f(i,k),f(i,g),q.block.m(g,q.anchor=null),q.mount=()=>g,q.anchor=null,f(i,R),f(i,H),f(H,U),f(U,Q),f(H,K),f(H,L),f(L,j),f(H,D),f(H,V),f(V,W),f(l,se),f(l,B),_e(N,B,null),a[21](B),f(l,I),f(l,T),a[22](T),J=!0,te||(ee=[ne(window,"message",a[8]),ne(L,"click",a[19]),ne(V,"click",a[20])],te=!0)},p($,[M]){a=$;const fe={};!w&&M&8&&(w=!0,fe.selectedItem=a[3],rt(()=>w=!1)),b.$set(fe),q.ctx=a,M&16&&C!==(C=a[4])&&Oe(C,q)||ct(q,a,M),(!J||M&8)&&G!==(G=a[3].text+"")&&Z(Q,G),(!J||M&8&&x!==(x=a[3].name==="Config Settings"))&&(L.disabled=x),(!J||M&8&&Y!==(Y=a[3].name==="Config Settings"))&&(V.disabled=Y),(!J||M&2)&&de(l,"--container-size",a[1]+"%")},i($){J||(ve(e.$$.fragment,$),ve(o.$$.fragment,$),ve(b.$$.fragment,$),ve(N.$$.fragment,$),J=!0)},o($){pe(e.$$.fragment,$),pe(o.$$.fragment,$),pe(b.$$.fragment,$),pe(N.$$.fragment,$),J=!1},d($){$&&(h(t),h(l)),ge(e,$),ge(o),ge(b),q.block.d(),q.token=null,q=null,ge(N),a[21](null),a[22](null),te=!1,Ce(ee)}}}function Pt(a,e,t){let l,n,s,d,r,o,c,i;oe(a,_t,D=>t(13,s=D)),oe(a,vt,D=>t(14,d=D)),oe(a,ft,D=>t(16,c=D)),oe(a,pt,D=>t(23,i=D));let u=null,m;const E=ze(90);oe(a,E,D=>t(1,r=D));const b=ze({title:{checked:!1,field:"title",view:"Title",value:i.title},description:{checked:!1,field:"description",view:"Description",value:i.description},authors:{checked:!1,field:"authors",view:"Authors",value:i.authors,tag:"div"},orgs:{checked:!1,field:"orgs",view:"Organizations",value:i.orgs},article:{checked:!1,field:"article",view:"Article",value:i.article},d3fend_version:{checked:!1,field:"d3fend_version",view:"D3FEND Version",value:i.d3fend_version},references:{checked:!1,field:"references",view:"References",value:i.references},published_date:{checked:!1,field:"published_date",view:"Date",value:i.published_date}});oe(a,b,D=>t(15,o=D));const w={"index.html":{name:"index.html",download:"index.html",text:"Complete HTML/Javascript runnable script",func:St},"Svelte Compenent":{name:"Svelte Compenent",download:"D3fendProfile.svelte",text:"Composable Svelte Compoenent runnable in Svelte Application",func:Ct}};let k=w["index.html"];const g=async(D,V,W)=>(await ot(),k.func(D,V,W)),C=D=>{var V;((V=D.data)==null?void 0:V.call)==="FromParent"&&u.contentWindow.postMessage({call:"toParent",value:{nodes:d,edges:s,meta:{settings:{}}}},D.origin)},R=D=>{D&&D.text&&t(3,k=D)},H=async(D,{func:V,download:W})=>{const Y=V({size:r,domain:l},{nodes:d,edges:s});mt(Y,W)},U=async(D,{func:V})=>{const W=V({size:r,domain:l},{nodes:d,edges:s});try{await navigator.clipboard.writeText(W)}catch(Y){console.error("Failed to copy: ",Y)}},G=D=>R(D);function Q(D){k=D,t(3,k)}const K=D=>H(D,k),L=D=>U(D,k);function j(D){be[D?"unshift":"push"](()=>{m=D,t(0,m)})}function x(D){be[D?"unshift":"push"](()=>{u=D,t(2,u)})}return a.$$.update=()=>{a.$$.dirty&65536&&t(12,l=c.url.origin),a.$$.dirty&61443&&t(4,n=g({size:r,domain:l},{nodes:d,edges:s},{metadataComp:m,$metaData:o}))},[m,r,u,k,n,E,b,w,C,R,H,U,l,s,d,o,c,G,Q,K,L,j,x]}class Jt extends Se{constructor(e){super(),Ae(this,e,Pt,Nt,ye,{})}}export{Jt as component};
